...
public class GestorDatos {
    public static Inmobiliaria leerArchivoVentas(Inmobiliaria inmobiliaria, String direccionArchivo, Cliente cliente, Vendedor vendedor, Inmueble inmueble) {
        String textoArchivo = "";
        ...
        try {
            ...
            while ((textoArchivo = br.readLine()) != null) {
                ...
                inmobiliaria.venta(vendedor, cliente, inmueble);
            }
            br.close();
            fr.close();
        } catch (Exception e) {
